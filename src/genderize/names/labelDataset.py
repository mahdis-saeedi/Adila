...
2. Record unique names
3. Map unique name to gender 
4. Label datasets with gender, entries that could not find gender > male > to make male group bigger in favour of female group

GENDER VALUES (isfemale):
true: female
false: male
none: can't decide (prob: 0.0)
'''

import json, pandas as pd, numpy as np, pickle as pkl, grequests
